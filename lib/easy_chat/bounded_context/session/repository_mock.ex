defmodule EasyChat.BoundedContext.Session.RepositoryMock do
  @moduledoc false
  ...
  ## Mock callbacks
  def handle_call({:stub, stubbed_response}, _from, {listeners, _}) do
  ...
  def remove(content) do
    GenServer.call(__MODULE__, {:side_effect, {:remove, content}})
  end
